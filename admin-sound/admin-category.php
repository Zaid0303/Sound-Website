                        ...
                        <div class="table-responsive">
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                             ...
                             <tbody>
                              ...
                              $fetch_cat_result = mysqli_query($connection, $fetch_cat);
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                        <div class="flex align-items-center list-user-action">
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"  href="category-update.php?c-id=<?php echo $row["c_id"] ?>"><i class="ri-pencil-line"></i></a>
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Trash" href="category-trash.php?c-id=<?php echo $row["c_id"] ?>"><i class="ri-delete-bin-line"></i></a>
                                       </div>
                                     </td>
                                 </tr>
                                 <?php 
