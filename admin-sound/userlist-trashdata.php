                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="userlist-delete.php?u-id=<?php echo $row["u_id"] ?>"><i class="ri-delete-bin-line"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php 
