               ...
               <div class="col-sm-12">
                  <div class="iq-card">
                     ...
                     <div class="iq-card-body">
                        <form action="insert-addcategory.php" method="POST">
                           <div class="row">
                              <div class="col">
                                <div class="form-group">
                                    <label>Genre:</label>
                                    <input type="text" name="cat-genre" class="form-control" required>
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                    <label>Year:</label>
                                    <input type="text" name="cat-year" class="form-control" required>
                                </div>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col">
                                <div class="form-group">
                                    <label>Artist:</label>
                                    <input type="text" name="cat-artist" class="form-control" required>
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                    <label>Album:</label>
                                    <input type="text" name="cat-album" class="form-control" required>
                                </div>
                              </div>
                           </div>
