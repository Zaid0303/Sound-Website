...
if(isset($_POST['addvideo'])){
    ...
    !empty($video_language) AND !empty($video_file_img) AND !empty($video_file)){
        ...
        $insert_video = "INSERT INTO `videos` (`v_id`, `v_name`, `v_artist`, `v_year`, `v_album`, `v_genre`, `v_language`, `v_img`, `v_file`) 
        VALUES (NULL, '$video_name', '$video_artist', '$video_year', '$video_album', '$video_genre', '$video_language', '$video_file_img', '$video_file')";
