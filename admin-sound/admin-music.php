                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Trash" href="music-trash.php?m-id=<?php echo $row["m_id"] ?>"><i class="ri-delete-bin-line"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php 
